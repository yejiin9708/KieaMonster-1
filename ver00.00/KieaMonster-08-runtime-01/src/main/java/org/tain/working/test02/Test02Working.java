package org.tain.working.test02;
...
public class Test02Working {
	 ...
	 */
	public void jobForStream() throws Exception {
		...
		if (!Flag.flag) {
			...
			process.waitFor();
			System.out.println("> EXIT_VALUE = " + process.exitValue());
			process.destroy();
		}
		...
		if (!Flag.flag) {
			...
			FileOutputStream fos = new FileOutputStream("/tmp/08-runtime-01_Test02Working.log" /* filename */);
