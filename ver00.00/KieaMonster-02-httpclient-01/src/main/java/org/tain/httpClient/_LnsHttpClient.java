...
@Component
@Slf4j
public class _LnsHttpClient {

	public _LnsJsonNode get(_LnsJsonNode lnsJsonNode) throws Exception {
	...
	public _LnsJsonNode post(_LnsJsonNode lnsJsonNode) throws Exception {
